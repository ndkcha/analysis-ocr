...
plt.legend()
plt.title("Intensity: 34x40")

print("Histogram of Gradient\n")
import_hog.preprocess_data(34)
...
tt_kNN_3 = np.zeros([20, 2])
tt_kNN_5 = np.zeros([20, 2])
tt_kNN_7 = np.zeros([20, 2])
tt_SVM = np.zeros([20, 2])

for i in np.arange(20):
    import_paper.preprocess_data((34, 40), (-1, 17, 20), 4, 40*(i+1))
    print(i+1, "\r")
